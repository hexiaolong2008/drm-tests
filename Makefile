...
all: CC_BINARY(atomictest) CC_BINARY(drm_cursor_test) CC_BINARY(gamma_test) CC_BINARY(linear_bo_test) CC_BINARY(null_platform_test) CC_BINARY(plane_test) CC_BINARY(stripe) CC_BINARY(swrast_test) CC_BINARY(vgem_fb_test) CC_BINARY(vgem_test)
